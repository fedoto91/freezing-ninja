		...
		<div id="contentBackground">
			<div id="leftSidebar">
				...
				<div class = "middleColumn">
					...
					<div class = "middleBannerTitle">PARTY</div>
						<a href="party/0.php"><img src="core/images/index/party.JPG" alt="Insert image here" width="270px"
						height="230px" class = "middleImage" /></a>
					</div><!--End of sectionBox-->
					
					<div class = "sectionBox">
					<div class = "middleBannerTitle">FASHION</div>
						<a href = "fashion/0.php"><img src="core/images/index/Fashion.JPG" alt="Insert image here" width="270px"
						height="230px" class = "middleImage" /></a>
					</div><!--End of sectionBox-->
					
					<div class = "sectionBox">
					<div class = "middleBannerTitle">GIRLS</div>
						<a href="girls/0.php"><img src="core/images/index/Girls.JPG" alt="Insert image here" width="270px"
						height="230px" class = "middleImage" /></a>
					</div><!--End of sectionBox-->
				...
				<div class = "middleColumn">
					<div class = "sectionBox">
					<div class = "middleBannerTitle">FASHION</div>
						<a href="#"><img src="core/images/index/Fashion.JPG" alt="Insert image here" width="270px"
						height="230px" class = "middleImage" /></a>
					</div><!--End of sectionBox-->
					
					<div class = "sectionBox">
					<div class = "middleBannerTitle">PARTY</div>
						<a href=""><img src="core/images/index/party.JPG" alt="Insert image here" width="270px"
						height="230px" class = "middleImage" /></a>
					</div><!--End of sectionBox-->
					
					<div class = "sectionBox">
					<div class = "middleBannerTitle">MEMES</div>
						<a href="memes/0.php"><img src="core/images/index/Meme.JPG" alt="Insert image here" width="270px"
						height="230px" class = "middleImage" /></a>
					</div><!--End of sectionBox-->
