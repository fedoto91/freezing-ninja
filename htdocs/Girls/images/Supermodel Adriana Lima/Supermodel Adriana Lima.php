...
$article = 'Supermodel Adriana Lima';									
$commentName = "";
if (isset($_POST['name']))
			...
			<div id="leftSidebar">
				...
				<div class = "articleMiddleColumn">
					...
					//Print out articles						
						...
						$getquery = mysql_query("SELECT * FROM girls WHERE girls_title = '$article'");
							while($rows = mysql_fetch_assoc($getquery)) {
								$date = $rows['girls_date'];
								$views = $rows['girls_views'];
							}
							
						echo '<div class = "article">';
						echo '<div class = "articleTitle">' . $article . '</div>';
						echo '<div class = "articleDate">' . $date . '</div>';
						$views++; //This increments only once.
						echo 'Views: ' . $views;
						mysql_query("UPDATE girls SET girls_views = '$views' WHERE girls_title = '$article'");
						
						$getquery=mysql_query("SELECT * FROM images WHERE images_article = '$article'");
							while($rows = mysql_fetch_assoc($getquery)) {
								$title = $rows['images_title'];
								$width = $rows['images_width'];
								$height = $rows['images_height'];
								//$article = $rows['images_article'];
								$iterator++;
					...
					//	echo $iterations;
						...
						echo '<img src = "' . $iterator . '.jpg" alt="Inset Image here" width = "' . $width . '" height = "' . $height . '" id="girlsImage" /><p>';
